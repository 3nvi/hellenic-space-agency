...
el:
  ...
  - title: 'Ερευνητικές υποτροφίες στο Ευρωπαϊκό Κέντρο Αστροναυτών της ESA στο Porz-Wahn
      της Γερμανίας '
    body: |-
      Το [Spaceship EAC](https://www.esa.int/About_Us/EAC/Spaceship_EAC), μια καινοτόμα πρωτοβουλία, λειτουργεί στο [Ευρωπαϊκό Κέντρο Αστροναυτών](https://www.esa.int/About_Us/EAC) στη Γερμανία και βοηθά την [ESA](https://www.esa.int/) και τους ερευνητές της να προετοιμαστούν για το μέλλον της διαστημικής εξερεύνησης.

      Η [Διεύθυνση Προγραμμάτων Ανθρώπινης και Ρομποτικής Εξερεύνησης (ExPeRT)](https://www.esa.int/Science_Exploration/Human_and_Robotic_Exploration/EXPERT) του Spaceship EAC, έχει προκηρύξει ερευνητικές υποτροφίες για φοιτητές που βρίσκονται στα τελευταία έτη των μεταπτυχιακών σπουδών τους.
