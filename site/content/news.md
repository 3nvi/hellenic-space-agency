...
en:
  ...
  - title: International award for "The [uncertain] four seasons" concert
    body: The [ALPHA MISSION-Delos](https://alphamission.delos.earth/) concert ["The
      ...
      with the Hellenic Space Center, Europa Nostra, the National Centre for Natural
  ...
  - title: ASI-HSC Webinar
    body: |-
      ...
      * Nanosatellites and Space technologies
      ...
      The event will start with introductory presentations from the two Agencies, and will be followed by an industry session where companies will present their capabilities, heritage, and perspectives on Greek-Italian Space cooperation. View the program [here](https://1drv.ms/b/s!AilfZNKr6I_V3xPKzm8e25OoZ5Tx).
  ...
  - title: 'Concert: "The [uncertain] Four Seasons"'
    body: 'On Monday, May 30, 20:30, [ALPHA MISSION – ΔELOS](https://youtu.be/iqkOwMNKuxs)
      ...
      Four Seasons](https://the-uncertain-four-seasons.info/)”. It will take place
...
el:
  ...
  items:
  - title: Προκήρυξη Ανοικτού Διεθνούς Ηλεκτρονικού Διαγωνισμού για τη σύναψη Συμφωνίας-Πλαίσιο
    body: Στο πλαίσιο του Έργου «Υπηρεσία Προγραμματισμού Δορυφορικών Αποστολών
      Παρατήρησης Γης» το οποίο προσφάτως εντάχθηκε στο Ταμείο Ανάκαμψης και Ανθεκτικότητας
      (κωδικός ΟΠΣ ΤΑ 5201107), το Ελληνικό Κέντρο Διαστήματος ανακοινώνει την προκήρυξη
      Ανοικτού Διεθνούς Ηλεκτρονικού Διαγωνισμού για τη σύναψη Συμφωνίας-Πλαίσιο για
      το υποέργο (Α/Α 1) «Υπηρεσία Προγραμματισμού Δορυφορικών Αποστολών Παρατήρησης
      Γης». Το Τεύχος της Προκήρυξης του Διαγωνισμού είναι διαθέσιμο στον ακόλουθο
      [σύνδεσμο](/assets/announcement_of_tender_for_framework_agreement.pdf).
    date: 2023-03-21T22:30:00Z
  - title: Ημέρα Σταδιοδρομίας στις Διαστημικές Τεχνολογίες, Εφαρμογές και Υπηρεσίες
      Made in Greece
    body: Ο Πρύτανης του [Εθνικού και Καποδιστριακού Πανεπιστημίου Αθηνών](https://www.uoa.gr/
      ), το Διιδρυματικό Πρόγραμμα Μεταπτυχιακών Σπουδών στις «[Διαστημικές Τεχνολογίες,
      Εφαρμογές και Υπηρεσίες](http://star.uoa.gr/ )» και το Πρόγραμμα Προπτυχιακών
      Σπουδών στην «[Αεροδιαστημική Επιστήμη και Τεχνολογία](http://www.aerospace.uoa.gr/
      )» οργανώνουν για τους φοιτητές τους την Ημέρα Σταδιοδρομίας στις Διαστημικές
      Τεχνολογίες, Εφαρμογές και Υπηρεσίες Made in Greece. Η εκδήλωση επρόκειτο να
      πραγματοποιηθεί την Τρίτη, 21 Μαρτίου 2023 με ώρα έναρξης 09.00 π.μ. και αναβάλλεται.
      Η εκδήλωση θα μετατεθεί σε νέα ημερομηνία που θα ανακοινωθεί το επόμενο διάστημα.
      [Μάθετε περισσότερα](https://hub.uoa.gr/career-day-in-space-technologies-applications-and-services-made-in-greece/
      )
    date: 2023-03-20T10:30:22Z
  - title: 'Ο Πρόεδρος του ΕΛ.ΚΕ.Δ. στο Khalifa University, Abu Dhabi '
    body: Τη Δευτέρα, 13 Μαρτίου, ο Πρόεδρος του ΕΛ.ΚΕ.Δ., Καθ. Ιωάννης Δαγκλής, επισκέφθηκε
      το [Khalifa University](https://www.ku.ac.ae/ ), το σημαντικότερο Πανεπιστήμιο
      των Ηνωμένων Αραβικών Εμιράτων, όπου έδωσε ομιλία και είχε σειρά επαφών.
    date: 2023-03-13T09:30:06Z
  - title: 'Το ΕΛ.ΚΕ.Δ. στο SpaceOps 2023 '
    body: Την Τετάρτη, 8 Μαρτίου, Ο Πρόεδρος του ΕΛ.ΚΕ.Δ., Καθ. Ιωάννης Δαγκλής, έδωσε
      μια ομιλία για τον ρόλο του ΕΛ.ΚΕ.Δ. στο εθνικό πρόγραμμα μικροδορυφόρων παρατήρησης
      της Γης στο διεθνές συνέδριο [SpaceOps 2023](https://spaceops2023.org/ ) στο
      Dubai (Ηνωμένα Αραβικά Εμιράτα).
    date: 2023-03-08T09:30:16Z
  - title: 'Παρουσίαση ΕΕΠ του ΕΛ.ΚΕ.Δ. σε διάλεξη του ΑΠΘ '
    body: Την Παρασκευή, 20 Ιανουαρίου 2023, μέλη του Επιστημονικού Προσωπικού του
      Ελληνικού Κέντρου Διαστήματος παρουσίασαν θέματα Διαστημικής Μηχανικής σε φοιτητές
      του Τμήματος Ηλεκτρολόγων Μηχανικών και Μηχανικών Υπολογιστών του [Αριστοτελείου
      Πανεπιστημίου Θεσσαλονίκης](https://www.auth.gr/ ), κατόπιν πρόσκλησης από τον
      Καθηγητή κ. Αλκιβιάδη Χατζόπουλο, στα πλαίσια του μαθήματος «Αξιοπιστία Συστημάτων».
    date: 2023-03-03T10:00:35Z
  - title: Ευκαιρίες απασχόλησης στον Ευρωπαϊκό Οργανισμό Διαστήματος
    body: Το 2023, η [ESA](https://www.esa.int/) θα προσλάβει πάνω από 200 νέους συναδέλφους
      για να ενταχθούν στις ομάδες της και να υποστηρίξουν την αποστολή της για ειρηνική
      εξερεύνηση και χρήση του διαστήματος προς όφελος όλων. Πρόσφατα έχουν ανακοινωθεί
      περισσότερες από 30 κενές θέσεις, και πολλές άλλες θα ακολουθήσουν. [Μάθετε
      περισσότερα](https://www.esa.int/About_Us/Careers_at_ESA/ESA_recruits_and_not_only_astronauts._Apply_now
      )
    date: 2023-03-03T09:40:10Z
  ...
  - title: The Summer School Alpbach – Θερινό Σχολείο Επιστήμης και Τεχνολογίας του
    ...
    body: 'Το Θερινό Σχολείο «[Summer School Alpbach](https://www.summerschoolalpbach.at/)»
      θα πραγματοποιηθεί το καλοκαίρι του 2023 στην Αυστρία και θα υποδεχτεί 60 επιλεγμένους
      συμμετέχοντες από τα κράτη μέλη του Ευρωπαϊκού Οργανισμού Διαστήματος (ESA),
      όπως είναι η Ελλάδα. Το θέμα του είναι «Εξωπλανήτες: Κατανοώντας εξωγήινους
  ...
  - title: Το ΕΛ.ΚΕ.Δ. στο 18th Ilan Ramon Space Conference
    body: 'Στο περιθώριο του διεθνούς συνεδρίου [18th Ilan Ramon Space Conference](https://ramonspaceconference2023.com/)
      ...
      με τον Πρόεδρο και τον Διευθυντή της [Ισραηλινής Διαστημικής Υπηρεσίας (ISA)](https://www.space.gov.il/en),
      Καθ. Dan Blumberg και κ. Uri Oron, και συζήτησαν θέματα κοινού ενδιαφέροντος
  ...
  - title: Διαγωνισμός NameExoWorlds 2022 (Greece)
    body: "Με τη συμπλήρωση 10 χρόνων από την ίδρυση του [Γραφείου για την Διάχυση
      ...
      - OAO), η [Διεθνής Αστρονομική Ένωση](https://www.iau.org/) (International Astronomical
      Union - IAU) προκηρύσσει διαγωνισμό για την ονοματοδοσία 20 εξωπλανητικών συστημάτων,
      τα οποία θα παρατηρηθούν με την βοήθεια του [διαστημικού τηλεσκοπίου James Webb](https://webb.nasa.gov/)
      (JWST). Ο διαγωνισμός [NameExoWorlds 2022](https://www.nameexoworlds.iau.org/2022edition
      ) επιδιώκει να φέρει σε επαφή τους επαγγελματίες αστρονόμους με το ευρύτερο
      κοινό, δίνοντάς τους την ευκαιρία να βαφτίσουν τους 20 επιλεγμένους εξωπλανήτες
      και τα μητρικά τους άστρα.\n\nΟ διαγωνισμός λαμβάνει χώρα σε εθνικό επίπεδο
      και συντονίζεται από ειδική επιτροπή της ευρύτερης αστρονομικής κοινότητας που
      εκπροσωπεί την IAU στη χώρα μας. Τα 3 καλύτερα ονόματα για κάθε χώρα θα προωθηθούν
  ...
  - title: 'Το ΕΛ.ΚΕ.Δ. στην Παγκόσμια Εβδομάδα Διαστήματος του ΕΚΠΑ '
    body: Το Ελληνικό Κέντρο Διαστήματος συμμετέχει στην εκδήλωση που οργανώνει ο
      ...
      του [Τμήματος Φυσικής του ΕΚΠΑ](https://www.phys.uoa.gr/), στο πλαίσιο της [Παγκόσμιας
      Εβδομάδας Διαστήματος](https://www.worldspaceweek.org/), το Σάββατο 8 Οκτωβρίου
      2022. Προσωπικό του ΕΛ.ΚΕ.Δ. θα πραγματοποιήσει δράση σχετικά με τον σχεδιασμό
      διαστημικής αποστολής στον Άρη για αναζήτηση πιθανής ζωής, περιλαμβάνοντας παρουσίαση,
      κατασκευή πυραύλου, διαστημοπλοίου και ρομποτικού οχήματος (rover) με χρήση
      πακέτου της LEGO, καθώς επίσης και ένα πείραμα αστροβιολογίας. Η συμμετοχή στη
  ...
  - title: Διεθνές βραβείο για τη συναυλία “Οι [αβέβαιες] τέσσερις εποχές”
    body: Η συναυλία του [ALPHA MISSION- ΔELOS](https://alphamission.delos.earth/)
      ...
      [μεταδόθηκε ζωντανά](https://youtu.be/VMBR9kenFrI) στις 30 Μαΐου σε όλη την
      Ευρώπη κέρδισε το βραβείο καλύτερης τηλεοπτικής συναυλίας στο 59ο Golden Prague
      International Festival. Η συναυλία ήταν συμπαραγωγή του World Human Forum και
      του ARTE/ZDF σε σύμπραξη με το Ελληνικό Κέντρο Διαστήματος, την Europa Nostra,
      το Εθνικό Κέντρο Έρευνας Φυσικών Επιστημών «Δημόκριτος», το Ελληνικό Ίδρυμα
  ...
  - title: 'Συμμετοχή κλιμακίου του ΕΛ.ΚΕ.Δ. στο International Astronautical Congress
    ...
    body: Ο Πρόεδρος, Ι. Δαγκλής, ο Διευθύνων Σύμβουλος, Ν. Σέργης, και Ειδικό Επιστημονικό
      Προσωπικό του ΕΛ.ΚΕ.Δ. (Δ. Μπληζιώτης, Δορυφορική Παρατήρηση της Γης) συμμετέχουν
      στο [International Astronautical Congress 2022](https://www.iafastro.org/events/iac/iac-2022/),
      το ετήσιο συνέδριο της [International Astronautical Federation (IAF)](https://www.iafastro.org/),
  ...
  - title: Νέοι Ειδικοί Επιστήμονες στο ΕΛ.ΚΕ.Δ.
    body: |-
      ...
      * Δ. Κ. Μυλωνάς, Διαστημικά Συστήματα
  ...
  - title: Συνεδρία προς τιμήν του Καθ. Yohsuke Kamide στο συνέδριο της AOGS
    body: Την Τρίτη, 2 Αυγούστου, ο Πρόεδρος του ΕΛ.ΚΕ.Δ., Καθ. Ιωάννης Δαγκλής, συμμετείχε
      ...
      Καθηγητή [Yohsuke Kamide](https://www.isee.nagoya-u.ac.jp/en/news/2021/20211220-2.html)
      κατά τη διάρκεια του ετήσιου συνεδρίου της [Asia Oceania Geosciences Society
  ...
  - title: Επίσκεψη κλιμακίων της NASA στο ΕΛ.ΚΕ.Δ.
    body: |-
      ...
      Συγκεκριμένα, τη Δευτέρα 18 Ιουλίου 2022, επισκέφθηκαν το ΕΛ.ΚΕ.Δ. από τη Διοίκηση της NASA ο Thomas Zurbuchen, αναπληρωτής διοικητής της NASA για τις Επιστημονικές Αποστολές, και η Kathy Lueders, αναπληρώτρια διοικήτρια της NASA για τις Διαστημικές Πτήσεις, με τους συνεργάτες τους, Rebecca Levy και Cullen Balinski. O Πρόεδρος του ΕΛ.ΚΕ.Δ. έκανε μια συνοπτική παρουσίαση του Κέντρου στους επισκέπτες και ακολούθησε συζήτηση σχετικά με την ανάπτυξη διμερούς συνεργασίας.
  ...
  - title: Επίσκεψη του Προέδρου του ΕΛ.ΚΕ.Δ. στο Ίδρυμα της Βουλής των Ελλήνων
    body: Ο Πρόεδρος του ΕΛ.ΚΕ.Δ. Καθηγητής Ιωάννης Δαγκλής επισκέφθηκε σήμερα, Τετάρτη
      ...
      Κοινοβουλευτισμό και τη Δημοκρατία](https://foundation.parliament.gr/el), Καθηγητή
  ...
  - title: Διαδικτυακή συνάντηση ASI-ΕΛ.ΚΕ.Δ.
    body: |-
      ...
      * Παρατήρηση της Γης και συναφείς εφαρμογές
      * Νανοδορυφόροι και Διαστημικές εφαρμογές

      Η εκδήλωση θα ξεκινήσει με εισαγωγικές παρουσιάσεις από τις δύο Υπηρεσίες και θα συνεχιστεί με μια ενότητα εστιασμένη στη βιομηχανία όπου εταιρείες του χώρου θα παρουσιάσουν τις δυνατότητες, την προηγούμενη εμπειρία, και τις προοπτικές της Ελληνο-Ιταλικής συνεργασίας. Δείτε το πρόγραμμα [εδώ](https://1drv.ms/b/s!AilfZNKr6I_V3xPKzm8e25OoZ5Tx).

      Μπορείτε να παρακολουθήσετε την εκδήλωση σε [αυτόν το σύνδεσμο](https://teams.microsoft.com/dl/launcher/launcher.html?url=%2F_%23%2Fl%2Fmeetup-join%2F19%3Ameeting_ZWZmMGUxMzktOTU1Ny00NmViLWJjZmItOTM1YWU2ZmI5YTVk%40thread.v2%2F0%3Fcontext%3D%257b%2522Tid%2522%253a%2522cbfc58d4-e60f-468d-8fe4-90676de085f7%2522%252c%2522Oid%2522%253a%2522446eb7b2-164b-4595-b0a2-7b6bfc3dfcb3%2522%257d%26anon%3Dtrue&type=meetup-join&deeplinkId=1553eb90-fe74-4f1a-9567-4713ff52ec23&directDl=true&msLaunch=true&enableMobilePage=true&suppressPrompt=true).

      Η ASI και το ΕΛ.ΚΕ.Δ. θα διευκολύνουν B2B συναντήσεις οι οποίες θα λάβουν χώρα τις επόμενες εβδομάδες. Για το σκοπό αυτό, έχει δημιουργηθεί μία φόρμα μέσω της οποίας οι ελληνικές εταιρείες μπορούν να εκδηλώσουν το ενδιαφέρον τους.
  ...
  - title: Νέοι Ειδικοί Επιστήμονες στο ΕΛ.ΚΕ.Δ.
    body: |-
      ...
      * Α. Παναγιωτόπουλος, Εφαρμογές Δορυφορικού Εντοπισμού και Πλοήγησης
  ...
  - title: 'Ομιλία: "Πλανητική Εξερεύνηση και η απασχόληση σε NASA και ESA"'
    body: 'Το [Περιφερειακό Κέντρο Εκπαιδευτικού Σχεδιασμού (ΠΕ.Κ.Ε.Σ.) Πελοποννήσου](https://blogs.sch.gr/pekespelop/)
      ...
      παρουσίαση της πλανητικής γεωλόγου Δρ. Ανεζίνας Σολωμονίδου, ερευνήτριας του
      Τομέα Διαστημικής Επιστήμης & Εξερεύνησης του Διαστήματος του ΕΛ.ΚΕ.Δ., με τίτλο:
  ...
  - title: Νέοι Ειδικοί Επιστήμονες στο ΕΛ.ΚΕ.Δ.
    body: |-
      ...
      * Χ. Παπαχρήστος, Οικονομικός Σύμβουλος
      * Α. Σολωμονίδου, Διαστημικές Επιστήμες και Εξερεύνηση του Διαστήματος
      * Δ. Μπληζιώτης, Δορυφορική Παρατήρηση της Γης
      * Α. Κάρμας, Διαστημικά Συστήματα Δεδομένων
  ...
  - title: 'Ομιλία: "Καταιγίδες, ήχοι και χρώματα στο Διάστημα"'
    body: 'Το [Περιφερειακό Κέντρο Εκπαιδευτικού Σχεδιασμού (ΠΕ.Κ.Ε.Σ.) Πελοποννήσου](https://blogs.sch.gr/pekespelop/)
      σε συνεργασία με το Ελληνικό Κέντρο Διαστήματος σας προσκαλεί στην εξ αποστάσεως
      παρουσίαση του Προέδρου του Ελληνικού Κέντρου Διαστήματος, Καθ. Ιωάννη Δαγκλή,
      με τίτλο: “Καταιγίδες, ήχοι και χρώματα στο Διάστημα”, η οποία θα πραγματοποιηθεί
      τη Δευτέρα 18 Απριλίου, στις 5:30 μμ., και θα μεταδοθεί ζωντανά από το κανάλι
  ...
  - title: 'Ομιλία: "Η Διαστημική Τεχνολογία στην υπηρεσία της γήινης καθημερινότητας"'
    body: 'Το [Περιφερειακό Κέντρο Εκπαιδευτικού Σχεδιασμού (ΠΕ.Κ.Ε.Σ.) Πελοποννήσου](https://blogs.sch.gr/pekespelop/)
      σε συνεργασία με το Ελληνικό Κέντρο Διαστήματος σας προσκαλεί στην εξ αποστάσεως
      παρουσίαση του Διευθύνοντα Σύμβουλου του Ελληνικού Κέντρου Διαστήματος, Δρ Νίκου
      Σέργη, με τίτλο: “Η Διαστημική Τεχνολογία στην υπηρεσία της γήινης καθημερινότητας”,
      η οποία θα πραγματοποιηθεί τη Δευτέρα 11 Απριλίου, στις 5:30 μμ, και θα μεταδοθεί
  ...
  - title: Επιτροπή Επιστημονικού Προγράμματος της COSPAR
    body: Την Τρίτη 15 Μαρτίου, ο Πρόεδρος και ο Διευθύνων Σύμβουλος του ΕΛ.ΚΕ.Δ.
      ...
      του διεθνούς συνεδρίου της [COSPAR](https://cosparhq.cnes.fr/ ), το οποίο θα
  ...
  - title: Μουσική εκδήλωση και ομιλίες υπό την αιγίδα του ΕΛ.ΚΕ.Δ.
    body: "Το Ερευνητικό Πρόγραμμα [SafeSpace](https://www.safespace-h2020.eu/), στο
      ...
      εκδήλωση με τίτλο «_Ανιχνεύοντας και ψηλαφώντας τους ήχους του διαστήματος_»,
      την Παρασκευή 18 Φεβρουαρίου 2022, στις 21:00. Στην εκδήλωση, η οποία πραγματοποιήθηκε
      στο [Ίδρυμα Θεοχαράκη](https://thf.gr/), υπό την αιγίδα του Ελληνικού Κέντρου
      Διαστήματος, παρουσιάστηκαν, για πρώτη φορά σε κοινό, τα έργα «_Electron Emissions_»
      και «_Radiation Belts_» της βραβευμένης συνθέτριας [Λίνας Τόνια](https://linatonia.com/),
      με εκτέλεση από τους μουσικούς Ρεζάρτα Κρούγια (βιολί), Μιμή Μουρατίδου (βιολί)
      και Μιχάλη Κοντό (βιολοντσέλο). Προηγήθηκαν ομιλίες από τον Πρόεδρο του ΕΛ.ΚΕ.Δ.,
  ...
  - title: 'Ερευνητικές υποτροφίες στο Ευρωπαϊκό Κέντρο Αστροναυτών της ESA στο Porz-Wahn
      της Γερμανίας '
    body: |-
      Το [Spaceship EAC](https://www.esa.int/About_Us/EAC/Spaceship_EAC), μια καινοτόμα πρωτοβουλία, λειτουργεί στο [Ευρωπαϊκό Κέντρο Αστροναυτών](https://www.esa.int/About_Us/EAC) στη Γερμανία και βοηθά την [ESA](https://www.esa.int/) και τους ερευνητές της να προετοιμαστούν για το μέλλον της διαστημικής εξερεύνησης. Η Διεύθυνση Προγραμμάτων Ανθρώπινης και Ρομποτικής Εξερεύνησης (ExPeRT) του Spaceship EAC, έχει προκηρύξει ερευνητικές υποτροφίες για φοιτητές που βρίσκονται στα τελευταία έτη των μεταπτυχιακών σπουδών τους.
  ...
  - title: 'Επίσκεψη της Πρέσβεως της Αργεντινής '
    body: Την Τετάρτη, 3 Νοεμβρίου 2021, επισκέφθηκε το Ελληνικό Κέντρο Διαστήματος
      ...
      Maria Lucia Dougherty de Sanchez. Η Πρέσβης είχε συνάντηση με τον Πρόεδρο του
      ΕΛ.ΚΕ.Δ., Καθ. Ιωάννη Δαγκλή, και τον Δ/ντα Σύμβουλο, Δρ. Νίκο Σέργη, κατά την
      οποία συζητήθηκε εκτενώς η δυνατότητα συνεργασίας του ΕΛ.ΚΕ.Δ. με τις κρατικές
  ...
  - title: 'Επίσκεψη Δ/ντή 3ου Ε.Κ. Αν. Αττικής - Ραφήνας '
    body: Την Τρίτη, 2 Νοεμβρίου 2021, επισκέφθηκε το ΕΛ.ΚΕ.Δ. ο κ. Α. Παλιούρας,
      ...
      για να παρουσιάσει το Διαστημικό πρόγραμμα εκπαίδευσης [“Earth from Space”](https://robotics-edu.gr/earth-from-space/),
      το οποίο αναπτύχθηκε τα τελευταία δύο χρόνια από τη Μαθητική Διαστημική Ομάδα
      Ραφήνας και αποτελείται από σειρά δραστηριοτήτων διαστημικής εκπαίδευσης. Το
      συγκεκριμένο πρόγραμμα απευθύνεται σε μαθητές/μαθήτριες Γυμνασίων και Λυκείων
      με σκοπό την ενημέρωσή τους σχετικά με τα επαγγέλματα του Διαστήματος, τη Διαστημική
  ...
  - title: 'Επίσκεψη Υφυπουργού Θ. Λιβάνιου στο ΕΛ.ΚΕ.Δ. '
    body: Την Τρίτη 19 Οκτωβρίου 2021 επισκέφθηκε το ΕΛ.ΚΕ.Δ. ο [Υφυπουργός Ειδικών
      ...
      με ομάδα συνεργατών του. Ο κ. Λιβάνιος συναντήθηκε με μέλη της Διοίκησης του
      ΕΛ.ΚΕ.Δ. και είχε την ευκαιρία να ενημερωθεί για τη λειτουργία του Κέντρου και
      ειδικότερα για την πρόταση του ΕΛ.ΚΕ.Δ. για τον σχεδιασμό, την ανάπτυξη και
  ...
  - title: Επίσκεψη του Καθ. Βασίλη Αγγελόπουλου, UCLA, στο ΕΛΚΕΔ
    body: Την Παρασκευή, 10 Σεπτεμβρίου 2021, ο κ. Βασίλης Αγγελόπουλος, Καθηγητής
      ...
      Επιστημονικός Υπεύθυνος των διαστημικών αποστολών [THEMIS](https://www.nasa.gov/mission_pages/themis/mission/index.html)
      και [ELFIN]() της [NASA](https://www.nasa.gov/), επισκέφθηκε τον Πρόεδρο του
