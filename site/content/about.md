...
el:
  ...
  mainSubtitle: Αποστολή, Διοίκηση & Ανθρώπινο Δυναμικό
  ...
  - name: Μανόλης Μυλωνάκης
    ...
    avatar: "/assets/mylonakis.jpeg"
  - name: 'Δημήτρης Μυλωνάς '
    role: Διαστημικά Συστήματα
    link: ''
    bio: "Διπλωματούχος της σχολής Ηλεκτρολόγων Μηχανικών και Μηχανικών Η/Υ του Εθνικού
      Μετσόβιου Πολυτεχνείου και κάτοχος μεταπτυχιακού τίτλου σπουδών στη Διαστημική
      Mηχανική του Πανεπιστημίου Surrey.  \n\nΈχει δουλέψει επί σειρά ετών (10 και
      πλέον) στην Airbus Defence & Space σε Γαλλία (Τουλούζη) και Αγγλία (Stevenage)
      ως μηχανικός λογισμικού, υπεύθυνος λειτουργικού ελέγχου, υπεύθυνος μελετών GNC
      και αρχιτέκτονας συστημάτων λογισμικού. Έχει συμμετάσχει στις αποστολές ExoMars
      Rover Vehicle, Sample Fetch Rover και Lagrange L5 και εργάστηκε ως υπεύθυνος
      ελέγχου του κεντρικού λογισμικού πτήσης της αποστολής Solar Orbiter, συντονίζοντας
      ομάδα 15 τουλάχιστον μηχανικών.  \n\nΈχει εργαστεί σε έργα έρευνας και ανάπτυξης
      διαστημικής τεχνολογίας στον ιδιωτικό τομέα, στην Ελλάδα, καθώς και στο κέντρο
      τεχνολογίας της ESA (ESTEC) στην Ολλανδία. "
    avatar: "/assets/mylonas-1.JPG"
  - name: Αναστάσιος Παναγιωτόπουλος
    role: Εφαρμογές Δορυφορικού Εντοπισμού και Πλοήγησης
    link: ''
  ...
  - name: Ανεζίνα Σολωμονίδου
    role: Διαστημικές Επιστήμες και Εξερεύνηση του Διαστήματος
    link: ''
  ...
  - name: Δημήτριος Χριστόπουλος
    role: Δορυφορικές Επικοινωνίες και Ολοκληρωμένες Εφαρμογές
    link: 'https://scholar.google.lu/citations?user=l82xdV4AAAAJ&hl=en '
